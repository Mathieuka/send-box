...
export const fetchQuestions: Promise<Question[]> = new Promise((resolve) => {
    setTimeout(() => resolve(questions), 400);
});

export const fetchSubmissions: Promise<Submission[]> = new Promise(
    (resolve) => {
        setTimeout(() => resolve(submissions), 400);
    }
);
